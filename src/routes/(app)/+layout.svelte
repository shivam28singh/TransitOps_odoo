					...
					<Sidebar.SidebarMenu>
						{#each links as link, idx (idx)}
							...
							<Sidebar.SidebarMenuItem class="my-0.5">
								...
								>
									{#snippet child({ props })}
										<a class="nodefault" {...props} href={resolve(link.href)}>
											<Icon class="size-4" />
						...
						{#if employee?.role === 'ADMIN'}
							<Sidebar.SidebarMenuItem>
								...
								>
									{#snippet child({ props })}
										<a class="nodefault" {...props} href={resolve('/admin')}>
		...
		<Sidebar.Footer class="border-sidebar-border">
			<DropdownMenu.Root>
				...
				<DropdownMenu.Content align="end" class="w-[200px]">
					...
					<a class="nodefault" href={resolve('/settings')}>
						<DropdownMenu.Item>Settings</DropdownMenu.Item>
					</a>
					<a class="nodefault" href={resolve('/signout')}>
